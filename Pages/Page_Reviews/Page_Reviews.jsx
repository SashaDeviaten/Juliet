                ...
                <div className={'container'}>
                    ...
                    <div className={mainClassName + ' row even tile'}>
                        <div className={'col-md-9 col-12 flex'}>
                            <div className={'ma'}>
                                <div className={'reviewsText'}>
                                    Стрижем уже не первый раз своего малыша шпица Джоника! Мастер очень внимательный и
                                    знающие свое дело! Спасибо Татьяне за её не легкий труд, и любовь к животным!
                                </div>
